...
export const MIEJSCA_LORWYNU = [
  ...
  { id: 'zrodlo', dzien: 'Source of Lanes', noc: null, x: 1020, y: 290, typ: 'akwen', fs: 14, woda: true,
    z: 'Mount_Tanufel', opis: 'małe jezioro źródłowe blisko szczytu Tanufel; nazwa tylko w dziennym zestawie, nocnego imienia kanon nie podaje (jak The Great Forest — F3, audyt PR-23)' },
