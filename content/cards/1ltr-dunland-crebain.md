...
Pierścienia ich przelot nad Hollin wystarcza, by wędrowcy ukryli się przed
niechcianym wzrokiem.

Crebainy działają jako **zwiadowcy Sarumana**. Same nie są armią i nie
muszą wygrywać walki. Ich znaczenie polega na tym, że zamieniają przestrzeń
w informację: kto rozpalił ogień, kto idzie otwartą drogą, kto nie zdążył
...
ziemia uraz, pamięci i łatwego gniewu pod ręką Isengardu. **Crebain** to
sindarińska liczba mnoga od *craban* — „kruk” albo „wrona”, słowo obcego
pochodzenia przyjęte do mowy elfów.

Pełne polskie odczytanie tytułu: **„Crebainy z Dunlandu”**. Tytuł nie
opisuje pojedynczego potwora, lecz stado związane z miejscem: ptaki są
częścią pogranicza tak samo jak kamienne zbocza, mgła i czujność tych,
którzy nie ufają niebu.
...
Najważniejszym kontekstem pozostaje scena z *Władcy Pierścieni*, w której
Drużyna ukrywa się przed czarną chmurą nad Hollin. Aragorn nie musi znać
każdego ptaka z imienia. Wystarczy mu świadomość, że nie wszystkim ptakom
można ufać — i że za lotem może stać wola Sarumana.
...
W regułach gry jest to stworzenie 1/1 za {2}{B} z lataniem oraz wejściem,
które każe **amass Orcs 2**. Latanie oddaje najprostszy fakt: ptaki są
ponad drogą, poza zasięgiem zwykłej piechoty, a więc widzą więcej, niż
przeciwnik chciałby pokazać.

Mała siła i wytrzymałość mówią, że pojedynczy crebain nie jest sednem
zagrożenia. Czarne mana i podtyp **Horror** przesuwają znaczenie z natury
ku grozie wojennej: to nie „ptak” jako część przyrody, lecz znak obcej woli.
Najważniejsza jest jednak zdolność amass. Kiedy stado przybywa, za nim
rośnie Armia Orków. Zwiad nie kończy sceny; zwiad uruchamia następny ruch.

Mechaniczna opowieść jest przez to bardzo zwarta: oczy pojawiają się w
powietrzu, raport spływa do dowództwa, a siła pod ziemią lub w wąwozie
zaczyna nabierać kształtu. Crebain nie musi zadać ciosu, żeby wygrać
pierwszą fazę bitwy. Wystarczy, że wskaże cel.
...
- J.R.R. Tolkien, *Władca Pierścieni* — przelot crebain nad Hollin
  i ostrzeżenie Aragorna, że nie wszystkim ptakom można ufać.
...
- **Zwiad poprzedza armię.** Crebainy pokazują, że wojna Sarumana zaczyna
  się od informacji, nie od pierwszego uderzenia topora.
- **Groza ptaków jest cudzą wolą za ich lotem.** Samo stado nie musi być
  silne; wystarczy, że patrzy dla kogoś potężniejszego.
- **Dunland jest tu ziemią pogranicznego napięcia.** Bliskość Isengardu,
  urazy wobec Rohanu i dziki krajobraz czynią z niego naturalne zaplecze
  takiej opowieści.

*Dunland Crebain* to mała karta o wielkiej wojennej kolejności: najpierw
niebo staje się oczami, potem ziemia zaczyna maszerować.
