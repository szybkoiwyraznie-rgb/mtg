...
plan: final-fantasy
kolory: [W]
tagi: [szpiedzy, ekspedycje]
materializacja: 2026-09-05
pinezka:
  mapa: final-fantasy/midgar
  pewnosc: dokladna
---

## Kronika Lore

Midgar nie zna ciszy, zna tylko zmiany warkotu: turkusowe światło
technicznych lamp nad turbinami, a w nim — czerwone rozbłyski alarmów.
Tej nocy w ogromnym szybie schodowym budynku Shinra schody zawracają
piętro za piętrem jak wnętrze maszyny, która sama nie wie, komu służy.
Na dole staje troje: mężczyzna z mieczem większym niż on sam, kobieta
w białej koszulce i czarnej spódnicy, olbrzym z karabinem zamiast
ramienia. Wyżej, o wiele wyżej, samotna sylwetka w różowej sukience
i czerwonej kamizelce — sprzedawczyni kwiatów z slumsów, którą
najpotężniejsza korporacja planety uważa za swój najcenniejszy
i najgroźniejszy nabytek.

Aerith Gainsborough nie jest zakładniczką przypadkową. Jest ostatnią
z Cetra — Ludu, który słyszy głos planety — a Shinra od dekad buduje
swoją potęgę na wysysaniu z planety życia. Dlatego właśnie Turks,
elegancka pięść korporacji, przyprowadziła ją do wieży. I dlatego
Avalanche — komórka, którą Shinra uważa za terrorystyczny margines —
wchodzi tej nocy do gardła wroga. Nie dla symbolu. Po swoją.
...
- Fandom, hasło Midgar — radialny układ sektorów, slumsy pod
  talerzami, budynek Shinra w hubie, Train Graveyard:
...
- **Pionowe miasto jako hierarchia władzy.** Midgar dosłownie
  ustawia ludzi w pionie: talerze nad slumsami, wieża Shinra nad
  wszystkim; ratunek Aerith jest pierwszym ruchem Avalanche
  „w górę, nie w dół”.
- **Wspólnota zamiast bohaterów-jednostek.** Scena i mechanika
  (wariant schodów: trzy tapnięcia, jeden cel) opowiadają o drużynie,
  w której każdy pcha każdego — Cloud idzie pierwszy, ale nie sam.
- **Shinra jako architekt własnej drogi.** Fabuła podkreśla ironię:
  schody, winda, pierścienie MMTS — infrastruktura kontroli staje się
  trasą ataku na kontrolującego.
- **Wybór drogi jako wybór etosu.** Winda (tokeny, szybkość, maszyna)
  kontra schody (59 pięter, ciało, upór) — dwie odpowiedzi na to samo
  pytanie, jak daleko wolno się posunąć po swoich.

Karta domyka w Kodeksie pierwszą scenę sagi Final Fantasy: nie bitwę
i nie podróż, lecz wejście — wspólnotę, która po raz pierwszy wspina
się po drabinie zbudowanej przez wroga.
