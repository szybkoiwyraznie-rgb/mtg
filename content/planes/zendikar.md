...
**Glint Pass**. Za murem krajobraz robi się pionowy: pasmo **Skyfang**
...
**Merfolkowie** — lud żeglarzy, uczonych i zwiadowców znad Halimar
i wybrzeży — dzielą się na trzy **wiary** (creeds), wybierane
w dorosłości, a wywiedzione od dawnych bóstw planu: **Emerii** (bogini
nieba i wiatru — jej imieniem nazwano też podniebne ruiny na Tazeem,
uważane za jej siedzibę), **Uli** (boga głębin) i **Cosiego**
(boga-trickstera ziemi). Wiara Emerii szuka mądrości i prawdy w siłach
mistycznych, słynie z wymijającej, enigmatycznej maniery; wiara Uli
stawia na twarde dowody i rozum — to analityczni kronikarze, badacze
i **nawigatorzy** (z tej tradycji wyrastają zawody przewodników, jak
bohaterka karty kolekcji); do wiary Cosiego nikt się otwarcie nie
przyznaje — jej wyznawcy widzą w tricksterze sprzymierzeńca dającego
władzę nad chaosem świata. Najmroczniejsza prawda planu: bóstwa te są
zniekształconym wspomnieniem tytanów **Eldrazi** (Emeria–Emrakul,
Ula–Ulamog, Cosi–Kozilek), a analogiczną trójcę czczą korowie
(Kamsa, Mangeni i Talib).

**Elfy** planu tworzą trzy narody. **Tajuru** — największy,
skoncentrowany na Murasie i rozsiany klanami po całym planie —
jest najbardziej otwarty na inne rasy i style życia. Wyniośli
**Joraga** z Bala Ged mają za cel wyłącznie przetrwanie własnego
narodu i tradycji; obcych wpływów unikają do tego stopnia, że omijają
nawet ścieżki przetarte przez Tajuru. **Mul Daya** (również Bala Ged,
w głębinach Kazandu) żyją w splocie ze światem duchów przodków —
śmierć jest dla nich częścią naturalnego porządku, a rozpoznać ich
można po tatuażach o motywie oplatających pnączy i truciznach
zbieranych w mrokach Kazandu.

**Gobliny** dzielą się na dziesiątki plemion, z których trzy są
największe: **Tuktuk** — najczęściej najmowani jako przewodnicy po
ruinach i znawcy pradawnych artefaktów; **Lavastep** z Akoum —
najbardziej wojowniczy i pracowici, mistrzowie wiedzy geotermalnej
i ekwipunku budowanego z kryształowych odłamków; oraz **Grotag** —
najmniejsi i najsłabsi, żyjący (z różnym skutkiem) ze sprytu
i z prób oswajania bestii, które zwykle ich zjadają.
...
- mtglore.com, „Gods and Monsters" (kopia artykułu Wizards, Savor the
  ...
  tytanów Eldrazi, Emeria jako podniebna siedziba bogini:
  <https://mtglore.com/web-articles/gods-and-monsters/>
- *Plane Shift: Zendikar* (Wizards of the Coast, PDF) — trzy wiary
  merfolków (wybór w dorosłości; charaktery Emerii/Uli/Cosiego), trzy
  narody elfów (Tajuru — największy, Murasa, otwartość; Joraga —
  Bala Ged, izolacjonizm; Mul Daya — duchy przodków, tatuaże-pnącza,
  Kazandu) i trzy plemiona goblinów (Tuktuk — przewodnicy po ruinach;
  Lavastep — Akoum, wiedza geotermalna; Grotag — spryt i oswajanie
  bestii):
