...
**Ru-Nora**, **Saronia**, **Orvada** i **Burning Isles**.

**Jamuraa** (południe) — tropikalny kontynent Zhalfiru, Suq'Aty,
lasu Yavimaya i Wielkiej Pustyni, nad Morzem Serenity.

**Otaria** (wschód) — kontynent bagiennego Urborga i wirem
Wiatru Apokalipsy; na północy archipelag Shiv.

**Terisiare** (północny wschód) — ziemia Argoth i Wojen Braci,
zamarznięta po Sylex Blast.

**Sarpadia** (południowy wschód) — ruiny upadłego imperium
thorne'ów nad Starym Morzem Voda.
