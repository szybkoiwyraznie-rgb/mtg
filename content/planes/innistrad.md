...
tagi: [geografia, demony, doktryna]
---
...
Nad światem wisi jeden **srebrny księżyc**, który wyznacza pory roku,
żniwa i cykle polowań potworów. Ludzie mieszkają w warownych wsiach
i miasteczkach, wieczorami zamykają okiennice, a w drogę wyruszają
wyłącznie za dnia — o ile dzień w ogóle nadejdzie, bo w Stensii słońca
prawie nie widać. Cztery **prowincje** to nie państwa, lecz okręgi
...
żywe. **Geisty** — duchy zmarłych, którzy nie zaznali Błogosławionego
Snu — są tu liczniejsze niż gdziekolwiek indziej. A **demonów** nie
...
ukazuje [[171isd-grizzled-outcasts|Grizzled Outcasts]], a budzące się
podszycie boru i pnącza więżące skrzydlatą abominację przy leśnej ściółce
ukazuje [[62avr-grounded|Grounded]].
...
się rykoszetem i archanioł została uwięziona razem ze swoim wrogiem.
Prawdę zachowano w tajemnicy, by nie wywołać paniki, a gdy Mikaeus
...
Ascension*: nie moment, w którym zło zwyciężyło, lecz ten, w którym
tarcza zaczęła pękać.

Kościół jest przy tym zepsuty od środka. W jego hierarchii — aż po
radę biskupów — działa **Skirsdag**, kult czcicieli demonów; jego
zwierzchnikiem był biskup **Volpaig**, a patronem sam Griselbrand.
Instytucja, która ma chronić przed piekłem, w części służy jego
mieszkańcom.

## Demony i diabły

Rozróżnienie jest tu odwrotne niż w większości opowieści. **Demony**
Innistradu to intryganci: knują, kuszą, zawierają pakty z kultystami
i wiedźmami, a ich cele sięgają dekad. **Diabły** to ich pragnienia
i popędy, które przybrały ciało — małe, czerwonoskóre stworzenia
o twarzach pełnych igiełkowatych zębów, wysokie na trzy, cztery stopy,
z rogami zagiętymi do tyłu. Nie mają planu i nie dbają o własne
bezpieczeństwo. Ich żywiołem jest sabotaż: niszczenie rzeczy cennych
i podjudzanie ludzi do przemocy.

To czyni je groźniejszymi, niż sugeruje ich wzrost. Diabeł nie
przychodzi zabić strażnika w pojedynku — przychodzi podciąć filar,
podpalić archiwum i zniknąć w dymie, zostawiając ludzi, by pozabijali
się w panice sami. Karta [[393dka-forge-devil|Forge Devil]] pokazuje
dokładnie tę scenę, w najniższych poziomach katedry.

## Mapa

`maps/innistrad/` — wariant **T1**: podkładem jest wysokiej jakości
raster (4096×3072), dostarczony przez właściciela. Wizards of the Coast
...
2. [Archive Trap: The World of Innistrad](https://www.mtgsalvation.com/articles/49486-archive-trap-the-world-of-innistrad) — układ prowincji, parafie Gavony, przełęcze Stensii, Ashmouth, natura demonów i diabłów, Skirsdag.
3. [The Prison of Silver](https://mtglore.com/web-articles/the-prison-of-silver/) — Doug Beyer: powstanie Helvaultu, pojedynek z Griselbrandem, zanik światła.
