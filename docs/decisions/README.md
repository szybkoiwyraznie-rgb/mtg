...
| [0024](0024-czytelnosc-map-t4.md) | Czytelność map T4: ikony miast/ruin w kołach z nieprzezroczystym tłem; granatowe etykiety wód (#1c3a5e); rozsiew biomów omija boxy etykiet; glify pasm w całości na lądzie; POI `iglica`; trakty między miastami kontynentu; reguły przejść i cieków | Zaakceptowana |
