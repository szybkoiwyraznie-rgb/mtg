...
| [0026](0026-fabula-kotwica-transpozycji.md) | Fabuła wraca do dostawy materializacji (imgId · nazwa · set · plan · Fabuła) jako WIĄŻĄCA kotwica transpozycji — sekcje osadzenia karty budowane z Fabuły (spójność z ilustracjami FOT/KON); higiena: osadzenie ≠ kanon MtG, oznaczanie w Źródłach | Zaakceptowana (doprecyzowanie 2026-09-05: widoczny termin „Fabuła" bez dopisku „dostawy" — patrz ADR) |
...
| [0030](0030-karta-katalogowa-lore-first.md) | Karta Katalogowa LORE-first: metryka techniczna tylko w infoboksie, główna treść głosem kronikarza, „Mechanika jako Opowieść" przy końcu przed Źródłami | Zaakceptowana (wyjątek meta „skrajnie zwięźle” §5 — wycofany, patrz ADR 0042) |
